import { Cupcake, RegisteredUser, Coupon, AllergenType } from './types';

export const DEFAULT_ALLERGENS: { id: string; name: AllergenType; icon: string }[] = [
  { id: 'alg-01', name: 'Glúten', icon: '🌾' },
  { id: 'alg-02', name: 'Lactose', icon: '🥛' },
  { id: 'alg-03', name: 'Ovos', icon: '🥚' },
  { id: 'alg-04', name: 'Nozes / Castanhas', icon: '🥜' },
  { id: 'alg-05', name: 'Soja', icon: '🌱' }
];
...
export const initialCupcakes: Cupcake[] = [
  ...
  },
  {
    ...
    ingredients: ['Farinha de trigo enriquecida', 'Xilitol premium', 'Estévia', 'Morangos frescos', 'Leite em pós desnatado', 'Ovos'],
    allergens: ['Glúten', 'Lactose', 'Ovos'],
    stock: 9,
    rating: 4.8,
    calories: 195
...
export const INITIAL_COUPONS: Coupon[] = [
  ...
  },
  {
    ...
    discountPercent: 15,
    minSubtotal: 40,
    description: '15% de desconto em pedidos acima de R$ 40,00'
  },
  {
    code: 'FRETEGRATIS',
    freeDelivery: true,
    minSubtotal: 30,
    description: 'Frete grátis para entregas acima de R$ 30,00'
  }
];
